...
print("\033[93mLets start PigTune Version...\n\033[0m")
...
def open_about_command(message):
    ...
    button1 = types.InlineKeyboardButton(text="Comming Soon", url="https://raw.githubusercontent.com/Mickekofi/pigtune")
    ...
    button5 = types.InlineKeyboardButton(text="What is in for this Update", url="https://raw.githubusercontent.com/Mickekofi/pigtune")
...
def open_link_command(message):
    # Create an inline keyboard
    keyboard = types.InlineKeyboardMarkup()
    button1 = types.InlineKeyboardButton(text="✅ Help", url="https://github.com/Mickekofi/pigtune")
    button2 = types.InlineKeyboardButton(text="❓ What Can EyeTubeBot Do", url="https://github.com/Mickekofi/pigtune")
...
def apply_sharpness(img, sharpness_percentage):
    ...
    Parameters:
        ...
        sharpness_percentage: Sharpness adjustment factor (-100 to 100). Positive values increase sharpness, negative decrease.
    
    Returns:
        Adjusted image with sharpness modified.
    """
...
def apply_brightness(img, brightness_percentage):
    ...
    Parameters:
        img: PIL.Image object
        brightness_percentage: Brightness adjustment factor (-100 to 100). Positive values increase brightness, negative decrease.
    
    Returns:
        Adjusted image with brightness modified.
    """
...
def apply_contrast(img, contrast_percentage):
    ...
    Parameters:
        img: PIL.Image object
        contrast_percentage: Contrast adjustment factor (-100 to 100). Positive values increase contrast, negative decrease.
    
    Returns:
        Adjusted image with contrast modified.
    """
...
def apply_saturation(img, saturation_percentage):
    ...
    Parameters:
        img: PIL.Image object
        saturation_percentage: Saturation adjustment factor (-100 to 100). Positive values increase saturation, negative decrease.
    
    Returns:
        Adjusted image with saturation modified.
    """
...
def apply_ambiance(img, ambiance_percentage):
    """
    Adjusts image ambiance, approximated through brightness.
    
    Parameters:
        img: PIL.Image object
        ambiance_percentage: Ambiance adjustment factor (-100 to 100). Positive values increase brightness, negative decrease.
    
    Returns:
        Adjusted image with ambiance modified.
    """
...
def apply_shadow(img, shadow_percentage):
    """
    Adjusts image shadows by approximating with brightness.
    
    Parameters:
        img: PIL.Image object
        shadow_percentage: Shadow adjustment factor (-100 to 100). Positive values increase brightness, negative decrease.
    
    Returns:
        Adjusted image with shadows modified.
    """
...
def apply_warmth(img, warmth_percentage):
    """
    Adjusts image warmth by approximating with color.
    
    Parameters:
        img: PIL.Image object
        warmth_percentage: Warmth adjustment factor (-100 to 100). Positive values increase color warmth, negative decrease.
    
    Returns:
        Adjusted image with warmth modified.
    """
...
def apply_structure(img, structure_percentage):
    """
    Adjusts image structure by enhancing contrast and sharpness.
    
    Parameters:
        img: PIL.Image object
        structure_percentage: Structure adjustment factor (-100 to 100). Positive values increase contrast and sharpness, negative decrease.
    
    Returns:
        Adjusted image with structure modified.
    """
...
def apply_highlights(img, highlights_percentage):
    """
    Adjusts highlights by increasing brightness on light areas.
    
    Parameters:
        img: PIL.Image object
        highlights_percentage: Highlights adjustment factor (0 to 100).
    
    Returns:
        Adjusted image with enhanced highlights.
    """
...
def apply_vignette(img, vignette_percentage):
    """
    Applies a vignette effect, darkening the image edges.
    
    Parameters:
        img: PIL.Image object
        vignette_percentage: Vignette effect strength (0 to 100).
...
def apply_clarity(img, clarity_percentage):
    """
    Enhances image clarity by increasing mid-tone contrast.
    
    Parameters:
        img: PIL.Image object
        clarity_percentage: Clarity adjustment factor (-100 to 100). Positive values increase contrast, negative decrease.
    
    Returns:
        Adjusted image with improved clarity.
    """
...
def apply_exposure(img, exposure_percentage):
    """
    Adjusts exposure by modifying the brightness, focusing on highlights.
    
    Parameters:
        img: PIL.Image object
        exposure_percentage: Exposure adjustment factor (-100 to 100). Positive values increase brightness, negative decrease.
    
    Returns:
        Adjusted image with exposure modified.
    """
...
def apply_blue_tone(img, blue_percentage):
    """
    Adjusts the blue color tone in the image.
    
    Parameters:
        img: PIL.Image object
        blue_percentage: Blue tone adjustment factor (-100 to 100). Positive values increase blue.
    
    Returns:
        Adjusted image with blue tone modified.
    """
...
def apply_red_tone(img, red_percentage):
    """
    Adjusts the red color tone in the image.
    
    Parameters:
        img: PIL.Image object
        red_percentage: Red tone adjustment factor (-100 to 100). Positive values increase red.
    
    Returns:
        Adjusted image with red tone modified.
    """
    r, g, b = img.split()  # Split into red, green, blue channels
...
def apply_white_tone(img, white_percentage):
    """
    Adjusts the white color tone in the image by enhancing all color channels equally.
    
    Parameters:
        img: PIL.Image object
        white_percentage: White tone adjustment factor (-100 to 100). Positive values increase white.
    
    Returns:
        Adjusted image with white tone modified.
    """
    r, g, b = img.split()  # Split into red, green, blue channels
...
def apply_black_and_white(img, bw_percentage):
    """
    Applies a black-and-white tone to the image.
    
    Parameters:
        img: PIL.Image object
        bw_percentage: Black-and-white tone adjustment factor (-100 to 100). Positive values increase B&W effect, negative decreases.
    
    Returns:
        Adjusted image with a black-and-white tone applied.
    """
...
def apply_yellow_tone(img, yellow_percentage):
    """
    Applies a yellow tone to the image.
    
    Parameters:
        img: PIL.Image object
        yellow_percentage: Yellow tone adjustment factor (-100 to 100). Positive values increase yellow tint, negative decrease.
    
    Returns:
        Adjusted image with a yellow tone applied.
    """
